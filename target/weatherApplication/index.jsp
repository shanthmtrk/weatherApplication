...
function lookupCountry(){
	...
	if($("#searchCountry").val().length > 0){
		...
		if(/^[a-zA-Z]*$/.test(countryString)){
			...
			$.ajax({
				type:"POST",
				url: "http://localhost:9090/weatherApp/country/"+countryString,
				async:false,
				crossDomain:true,
...
function lookupCity(country){
	...
	$.ajax({
		type:"POST",
		url: "http://localhost:9090/weatherApp/city/"+countryString,
		async:false,
		crossDomain:true,
		success:function(data){
			var cityCombo = $("#cityInput");
...
function getWeather(){
	...
	$.ajax({
		type:"POST",
		url: "http://localhost:9090/weatherApp/weather/"+countryString+"/"+cityString,
		async:false,
		crossDomain:true,
		success:function(data){
...
<body>
<h1 align="center"> Weather Information
<!--  <spring:message code="weather.title" text="default text" /> -->
</h1>
<table align="center">
<tr>
<td>
<label> <!--  <spring:message code="weather.searchCountryLabel" text="default text" /> --> Search Country:</label>
</td>
<td>
<input id="searchCountry"></input>
<button class="button" onClick="lookupCountry()"> <!-- <spring:message code="weather.lookupButton" text="default text" /> --> LookUp</button>
</td>
...
<tr>
<td>
<label><!--  <spring:message code="weather.selectCountryLabel" text="default text" /> -->Select Country:</label>
</td>
<td>
...
<tr>
<td>
<label><!--  <spring:message code="weather.selectCityLabel" text="default text" /> -->Select City:</label>
</td>
<td>
...
<tr>
<td>
<button class="button" onClick="getWeather()"><!-- <spring:message code="weather.getWeatherButton" text="default text" />  -->Get Weather</button>
</td>
<td>
<button class="button" onClick="clearAll()"><!-- <spring:message code="weather.resetButton" text="default text" /> --> Reset</button>
</td>
</tr>
</table>
<p>
